...
public:
    ...
    void setupUi(QMainWindow *MainWindow)
    {
        ...
        rightUpLong->setGeometry(QRect(410, 40, 91, 20));
        ...
        rightUpLat->setGeometry(QRect(470, 60, 91, 20));
        ...
        rightDownLong->setGeometry(QRect(430, 180, 81, 20));
        ...
        rightDownLat->setGeometry(QRect(470, 160, 81, 20));
        ...
        downBorder->setGeometry(QRect(320, 170, 141, 16));
        ...
        upBorder->setGeometry(QRect(320, 60, 141, 16));
        ...
        rightBorder->setGeometry(QRect(450, 70, 21, 111));
